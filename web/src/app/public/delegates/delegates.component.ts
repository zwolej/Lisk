...
export class DelegatesComponent {
  ...
  constructor(private route: ActivatedRoute) {
    route.params.subscribe(() => {
      ...
      this.mergeDatabaseInfoWithLisknet(liskDelegates, databaseDelegates);
    });
  }

  private mergeDatabaseInfoWithLisknet(liskDelegates: DelegateDto[], databaseDelegates: DelegateAdditionalDto[]) {
